...
#define L3_DESCRIPTOR_FAULT            ((u64) 0x0ULL)

#define L2_DESCRIPTOR_ADDR_MASK         (0xFFFFF000)
#define L3_DESCRIPTOR_ADDR_MASK_LPAE         ((u64) 0x000000FFFFFFF000ULL)
...
struct page *tf_l3_page_descriptor_to_page_lpae(u64 l3_page_descriptor);
