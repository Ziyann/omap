...
static struct omap_opp_def omap443x_opp_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER(&mpu_dev_info, true, 300000000,
			OMAP4430_VDD_MPU_OPP50_UV, "OPP50"),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER(&mpu_dev_info, true, 600000000,
			OMAP4430_VDD_MPU_OPP100_UV, "OPP_100"),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER(&mpu_dev_info, true, 800000000,
			OMAP4430_VDD_MPU_OPPTURBO_UV, "OPPTURBO"),
	/* MPU OPP4 - OPP-NT */
	OPP_INITIALIZER(&mpu_dev_info, true, 1008000000,
			OMAP4430_VDD_MPU_OPPNITRO_UV, "OPPNITRO"),
	/* MPU OPP5 - OPP-SB */
	OPP_INITIALIZER(&mpu_dev_info, false, 1200000000,
			OMAP4430_VDD_MPU_OPPNITROSB_UV, "OPPNITRPSB"),
	/* L3 OPP1 - OPP50 */
	OPP_INITIALIZER(&l3_dev_info, true, 100000000,
			OMAP4430_VDD_CORE_OPP50_UV, "OPP50"),
	/* L3 OPP2 - OPP100, OPP-Turbo, OPP-SB */
	OPP_INITIALIZER(&l3_dev_info, true, 200000000,
			OMAP4430_VDD_CORE_OPP100_UV, "OPP_100"),
	/* IVA OPP1 - OPP50 */
	OPP_INITIALIZER(&iva_dev_info, true, 133000000,
			OMAP4430_VDD_IVA_OPP50_UV, "OPP50"),
	/* IVA OPP2 - OPP100 */
	OPP_INITIALIZER(&iva_dev_info, true, 266100000,
			OMAP4430_VDD_IVA_OPP100_UV, "OPP_100"),
	/* IVA OPP3 - OPP-Turbo */
	OPP_INITIALIZER(&iva_dev_info, true, 332000000,
			OMAP4430_VDD_IVA_OPPTURBO_UV, "OPPTURBO"),
	/* ABE OPP1 - OPP50 */
	OPP_INITIALIZER(&abe_dev_info, true, 98304000,
			OMAP4430_VDD_IVA_OPP50_UV, "OPP50"),
	/* ABE OPP2 - OPP100 */
	OPP_INITIALIZER(&abe_dev_info, true, 196608000,
			OMAP4430_VDD_IVA_OPP100_UV, "OPP100"),
	/* FDIF OPP1 - OPP50 */
	OPP_INITIALIZER(&fdif_dev_info, true, 64000000,
			OMAP4430_VDD_CORE_OPP50_UV, "OPP50"),
	/* FDIF OPP2 - OPP100 */
	OPP_INITIALIZER(&fdif_dev_info, true, 128000000,
			OMAP4430_VDD_CORE_OPP100_UV, "OPP100"),
	/* DSP OPP1 - OPP50 */
	OPP_INITIALIZER(&dsp_dev_info, true, 232750000,
			OMAP4430_VDD_IVA_OPP50_UV, "OPP50"),
	/* DSP OPP2 - OPP100 */
	OPP_INITIALIZER(&dsp_dev_info, true, 465500000,
			OMAP4430_VDD_IVA_OPP100_UV, "OPP100"),
	/* DSP OPP3 - OPPTB */
	OPP_INITIALIZER(&dsp_dev_info, true, 496000000,
			OMAP4430_VDD_IVA_OPPTURBO_UV, "OPPTURBO"),
	/* HSI OPP1 - OPP50 */
	OPP_INITIALIZER(&hsi_dev_info, true, 96000000,
			OMAP4430_VDD_CORE_OPP50_UV, "OPP50"),
	/* HSI OPP2 - OPP100 */
	OPP_INITIALIZER(&hsi_dev_info, true, 192000000,
			OMAP4430_VDD_CORE_OPP100_UV, "OPP100"),
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER(&gpu_dev_info, true, 153600000,
			OMAP4430_VDD_CORE_OPP50_UV, "OPP50"),
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER(&gpu_dev_info, true, 307200000,
			OMAP4430_VDD_CORE_OPP100_UV, "OPP100"),
	/* TODO: add DSS */
};
...
static struct omap_opp_def omap446x_opp_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 350000000,
			OMAP4460_VDD_MPU_OPP50_UV, "OPP50"),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 700000000,
			OMAP4460_VDD_MPU_OPP100_UV, "OPP100"),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 920000000,
			OMAP4460_VDD_MPU_OPPTURBO_UV, "OPPTURBO"),
	/* MPU OPP4 - OPP-Nitro */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 1200000000,
			OMAP4460_VDD_MPU_OPPNITRO_UV, "OPPNITRO"),
	/* MPU OPP4 - OPP-Nitro SpeedBin */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, false, 1500000000,
			OMAP4460_VDD_MPU_OPPNITROSB_UV, "OPPNITROSB"),
	/* L3 OPP1 - OPP50 */
	OPP_INITIALIZER(&l3_dev_info, true, 100000000,
			OMAP4460_VDD_CORE_OPP50_UV, "OPP50"),
	/* L3 OPP2 - OPP100 */
	OPP_INITIALIZER(&l3_dev_info, true, 200000000,
			OMAP4460_VDD_CORE_OPP100_UV, "OPP100"),
	/* IVA OPP1 - OPP50 */
	OPP_INITIALIZER(&iva_dev_info, true, 133000000,
			OMAP4460_VDD_IVA_OPP50_UV, "OPP50"),
	/* IVA OPP2 - OPP100 */
	OPP_INITIALIZER(&iva_dev_info, true, 266100000,
			OMAP4460_VDD_IVA_OPP100_UV, "OPP100"),
	/* IVA OPP3 - OPP-Turbo */
	OPP_INITIALIZER(&iva_dev_info, true, 332000000,
			OMAP4460_VDD_IVA_OPPTURBO_UV, "OPPTURBO"),
	/* IVA OPP4 - OPP-Nitro */
	OPP_INITIALIZER(&iva_dev_info, true, 430000000,
			OMAP4460_VDD_IVA_OPPNITRO_UV, "OPPNITRO"),
	/* IVA OPP5 - OPP-Nitro SpeedBin*/
	OPP_INITIALIZER(&iva_dev_info, false, 500000000,
			OMAP4460_VDD_IVA_OPPNITROSB_UV, "OPPNITROSB"),
	/* FDIF OPP1 - OPP50 */
	OPP_INITIALIZER(&fdif_dev_info, true, 64000000,
			OMAP4460_VDD_CORE_OPP50_UV, "OPP50"),
	/* FDIF OPP2 - OPP100 */
	...
	OPP_INITIALIZER(&gpu_dev_info, true, 307200000,
			OMAP4460_VDD_CORE_OPP100_UV, "OPP100"),
	/* SGX OPP3 - OPP100_OV */
	OPP_INITIALIZER(&gpu_dev_info, true, 384000000,
			OMAP4460_VDD_CORE_OPP100_OV_UV, "OPP100_OV"),
	/* TODO: Add DSS */
};
...
static struct omap_opp_def omap447x_opp_low_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 396800000,
			OMAP4470_VDD_MPU_OPP50_UV, "OPP50"),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 800000000,
			OMAP4470_VDD_MPU_OPP100_UV, "OPP100"),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 1100000000,
			OMAP4470_VDD_MPU_OPPTURBO_UV, "OPPTURBO"),
	/* MPU OPP4 - OPP-Nitro */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, true, 1300000000,
			OMAP4470_VDD_MPU_OPPNITRO_UV, "OPPNITRO"),
	/* MPU OPP5 - OPP-Nitro SpeedBin */
	OPP_INITIALIZER(&omap4460_mpu_dev_info, false, 1500000000,
			OMAP4470_VDD_MPU_OPPNITROSB_UV, "OPPNITROSB"),
	/* L3 OPP1 - OPP50 */
	OPP_INITIALIZER(&l3_dev_info, true, 100000000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* L3 OPP2 - OPP100 */
	OPP_INITIALIZER(&l3_dev_info, true, 200000000,
			OMAP4470_VDD_CORE_OPP100_UV, "OPP100"),
	/* IVA OPP1 - OPP50 */
	OPP_INITIALIZER(&iva_dev_info, true, 133000000,
			OMAP4470_VDD_IVA_OPP50_UV, "OPP50"),
	/* IVA OPP2 - OPP100 */
	OPP_INITIALIZER(&iva_dev_info, true, 266100000,
			OMAP4470_VDD_IVA_OPP100_UV, "OPP100"),
	/* IVA OPP3 - OPP-Turbo */
	OPP_INITIALIZER(&iva_dev_info, true, 332000000,
			OMAP4470_VDD_IVA_OPPTURBO_UV, "OPPTURBO"),
	/* IVA OPP4 - OPP-Nitro */
	OPP_INITIALIZER(&iva_dev_info, true, 430000000,
			OMAP4470_VDD_IVA_OPPNITRO_UV, "OPPNITRO"),
	/* IVA OPP5 - OPP-Nitro SpeedBin */
	OPP_INITIALIZER(&iva_dev_info, false, 500000000,
			OMAP4470_VDD_IVA_OPPNITROSB_UV, "OPPNITROSB"),
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER(&gpu_dev_info, true, 153600000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* SGX OPP2 - OPP100 */
	...
	/* SGX OPP3 - OPPOV */
	OPP_INITIALIZER(&gpu_dev_info, true, 384000000,
			OMAP4470_VDD_CORE_OPP100_OV_UV, "OPP100_OV"),
	/* BB2D OPP1 - OPP50 */
	OPP_INITIALIZER(&bb2d_dev_info, true, 153600000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* BB2D OPP2 - OPP100 */
	OPP_INITIALIZER(&bb2d_dev_info, true, 307200000,
			OMAP4470_VDD_CORE_OPP100_UV, "OPP100"),
	/* BB2D OPP3 - OPP-OV */
	OPP_INITIALIZER(&bb2d_dev_info, true, 384000000,
			OMAP4470_VDD_CORE_OPP100_OV_UV, "OPP100_OV"),
	/* FDIF OPP1 - OPP25 */
	OPP_INITIALIZER(&fdif_dev_info, true, 32000000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* FDIF OPP2 - OPP50 */
	OPP_INITIALIZER(&fdif_dev_info, true, 64000000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
...
static struct omap_opp_def omap447x_opp_high_def_list[] = {
	...
	OPP_INITIALIZER(&omap4460_mpu_dev_info, false, 1500000000,
			OMAP4470_VDD_MPU_OPPNITROSB_UV, "OPPNITROSB"),
	/* L3 OPP1 - OPP50 */
	OPP_INITIALIZER(&l3_dev_info, true, 116000000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* L3 OPP2 - OPP-OV */
	OPP_INITIALIZER(&l3_dev_info, true, 233000000,
			OMAP4470_VDD_CORE_OPP100_OV_UV, "OPP100"),
	/* IVA OPP1 - OPP50 */
	OPP_INITIALIZER(&iva_dev_info, true, 133000000,
			OMAP4470_VDD_IVA_OPP50_UV, "OPP50"),
	/* IVA OPP2 - OPP100 */
	...
	OPP_INITIALIZER(&iva_dev_info, false, 500000000,
			OMAP4470_VDD_IVA_OPPNITROSB_UV, "OPPNITROSB"),
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER(&gpu_dev_info, true, 192000000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER(&gpu_dev_info, true, 307200000,
			OMAP4470_VDD_CORE_OPP100_UV, "OPP100"),
	...
	OPP_INITIALIZER(&gpu_dev_info, true, 384000000,
			OMAP4470_VDD_CORE_OPP100_OV_UV, "OPP100_OV"),
	/* BB2D OPP1 - OPP50 */
	OPP_INITIALIZER(&bb2d_dev_info, true, 192000000,
			OMAP4470_VDD_CORE_OPP50_UV, "OPP50"),
	/* BB2D OPP2 - OPP100 */
	OPP_INITIALIZER(&bb2d_dev_info, true, 307200000,
			OMAP4470_VDD_CORE_OPP100_UV, "OPP100"),
