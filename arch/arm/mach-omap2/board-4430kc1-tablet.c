...
static struct omap_board_mux board_mux[] __initdata = {
    OMAP4_MUX(SYS_NIRQ2, OMAP_MUX_MODE7),
    OMAP4_MUX(SYS_NIRQ1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_WAKEUP_EN),
    OMAP4_MUX(GPMC_AD12, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_AD14, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_A20, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_A21, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_A24, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_CLK, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_NADV_ALE, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_NBE0_CLE, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_WAIT0, OMAP_MUX_MODE7),
    OMAP4_MUX(GPMC_WAIT1, OMAP_MUX_MODE7),
    OMAP4_MUX(HDMI_HPD, OMAP_MUX_MODE7),
    OMAP4_MUX(HDMI_CEC, OMAP_MUX_MODE7),
    OMAP4_MUX(HDMI_DDC_SCL, OMAP_MUX_MODE7),
    OMAP4_MUX(HDMI_DDC_SDA, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI21_DX0, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI21_DY0, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI21_DX1, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI21_DY1, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI21_DX2, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI21_DY2, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI22_DX0, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI22_DY0, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI22_DX1, OMAP_MUX_MODE7),
    OMAP4_MUX(CSI22_DY1, OMAP_MUX_MODE7),
    OMAP4_MUX(CAM_SHUTTER, OMAP_MUX_MODE7),
    OMAP4_MUX(CAM_STROBE, OMAP_MUX_MODE7),
    OMAP4_MUX(CAM_GLOBALRESET, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_CLK, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_STP, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DIR, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_NXT, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT0, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT1, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT2, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT3, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT4, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT5, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_ULPITLL_DAT6, OMAP_MUX_MODE1 ),// Backlight GPTimer 10,
    OMAP4_MUX(USBB1_ULPITLL_DAT7, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_HSIC_DATA, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB1_HSIC_STROBE, OMAP_MUX_MODE7),
    OMAP4_MUX(USBC1_ICUSB_DP, OMAP_MUX_MODE7),
    OMAP4_MUX(USBC1_ICUSB_DM, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP2_CLKX, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP2_DR, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP2_DX, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP2_FSX, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP1_CLKX, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP1_DR, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP1_DX, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_MCBSP1_FSX, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_DMIC_DIN1, OMAP_MUX_MODE7),
    OMAP4_MUX(ABE_DMIC_DIN3, OMAP_MUX_MODE7),
    OMAP4_MUX(UART2_CTS, OMAP_MUX_MODE7),
    OMAP4_MUX(UART2_RTS, OMAP_MUX_MODE7),
    OMAP4_MUX(UART2_RX, OMAP_MUX_MODE7),
    OMAP4_MUX(UART2_TX, OMAP_MUX_MODE7),
    OMAP4_MUX(HDQ_SIO, OMAP_MUX_MODE7),
    ...
    OMAP4_MUX(MCSPI1_CS1, OMAP_MUX_MODE7 | OMAP_PIN_INPUT),
    OMAP4_MUX(MCSPI1_CS2, OMAP_MUX_MODE7),
    OMAP4_MUX(MCSPI1_CS3, OMAP_MUX_MODE7),
    OMAP4_MUX(MCSPI4_SOMI, OMAP_MUX_MODE7),
    OMAP4_MUX(UART4_RX, OMAP_MUX_MODE3 | OMAP_OFF_EN | OMAP_OFFOUT_VAL ), //Charger susp pin,
    OMAP4_MUX(UART4_TX, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB2_ULPITLL_CLK, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB2_HSIC_DATA, OMAP_MUX_MODE7),
    OMAP4_MUX(USBB2_HSIC_STROBE, OMAP_MUX_MODE7),
    OMAP4_MUX(FREF_CLK1_OUT, OMAP_MUX_MODE7),
    OMAP4_MUX(DPM_EMU2, OMAP_MUX_MODE7),
#if 0
...
static struct omap_board_mux board_mux_wkup[] __initdata = {
    OMAP4_MUX(SIM_IO, OMAP_MUX_MODE7),
    OMAP4_MUX(SIM_CLK, OMAP_MUX_MODE7),
    OMAP4_MUX(SIM_RESET, OMAP_MUX_MODE7),
    OMAP4_MUX(SIM_CD, OMAP_MUX_MODE7),
    OMAP4_MUX(SIM_PWRCTRL, OMAP_MUX_MODE7),
    ...
    OMAP4_MUX(FREF_CLK3_REQ, OMAP_MUX_MODE7),
    OMAP4_MUX(FREF_CLK3_OUT, OMAP_MUX_MODE7),
#if 0
...
static void __init omap_4430sdp_reserve(void)
{
	...
	omap4_kc1_android_display_setup();
#ifdef CONFIG_ION_OMAP
	omap4_ion_init();
#endif
