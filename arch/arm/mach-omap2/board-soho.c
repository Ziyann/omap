...
static struct twl4030_resconfig soho_twl_resconfig[] = {
	{
...
static struct twl4030_power_data soho_twl_power_data = {
	.resource_config = soho_twl_resconfig,
};
