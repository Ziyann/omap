...
static int __init omap4_twl6030_hsmmc_init(struct omap2_hsmmc_info *controllers)
{
	...
	/*
	 * Powerdown MMC1 PBIAS. As MMC1 slot is not used on Tate, and
...
#ifdef CONFIG_CHARGER_SMB347
static struct regulator_consumer_supply tate_ldo7_supply[] = {
	{
		.supply = "smb347_ldo7",
	},
};
...
#ifdef CONFIG_CHARGER_SMB347
	.num_consumer_supplies  = ARRAY_SIZE(tate_ldo7_supply),
	.consumer_supplies      = tate_ldo7_supply,
#endif
};
...
static struct regulator_init_data tate_vaux1_idata = {
	.constraints = {
		.min_uV			= 1000000,
		.max_uV			= 3000000,
		.apply_uV		= true,
...
static struct twl4030_platform_data tate_twldata = {
	/* TWL6030 regulators at OMAP443X/446X based SOMs */
//	.vaux1		= &tate_vaux1_idata,
	.vusim		= &sdp4430_vusim,
	.vcxio		= &sdp4430_vcxio,
	/* TWL6032 regulators at OMAP447X based SOMs */
//	.ldo2		= &tate_vaux1_idata,
	.ldo6		= &sdp4430_vcxio,
	.ldo7		= &sdp4430_vusim,
};
#ifdef CONFIG_SND_SOC_WM8962
...
#if defined(CONFIG_TOUCHSCREEN_ATMEL_MXT) || defined(CONFIG_TOUCHSCREEN_ATMEL_MXT_MODULE)
static struct mxt_platform_data touch_data = { /* atmel */
	.reset_gpio = GPIO_TOUCH_RESET,
	.read_chg = NULL,
};
#endif

static struct i2c_board_info __initdata tate_i2c_2_boardinfo[] = {
#if defined(CONFIG_TOUCHSCREEN_ATMEL_MXT) || defined(CONFIG_TOUCHSCREEN_ATMEL_MXT_MODULE)
	{
...
static struct i2c_board_info __initdata tate_i2c_3_boardinfo[] = {
...
static struct tate_i2c_info_t __initdata tate_i2c_info[] = {
	{
		.bus_id = 1,
	},
	{
		.bus_id = 2,
		.speed = 400,
		.board_info = &tate_i2c_2_boardinfo[0],
		.board_info_size = ARRAY_SIZE(tate_i2c_2_boardinfo),
	},
	{
		.bus_id = 3,
		.speed = 400,
		.board_info = &tate_i2c_3_boardinfo[0],
		.board_info_size = ARRAY_SIZE(tate_i2c_3_boardinfo),
	},
	{
		.bus_id = 4,
		.speed = 400,
		.board_info = &tate_i2c_4_boardinfo[0],
		.board_info_size = ARRAY_SIZE(tate_i2c_4_boardinfo),
	}
};
...
{
	int i;
	struct tate_i2c_info_t *inf;

	for(i=0,inf = &tate_i2c_info[0]; i < ARRAY_SIZE(tate_i2c_info); ++i, ++inf)
	{
	...
	omap4_pmic_get_config(&tate_twldata, TWL_COMMON_PDATA_USB |
	...
	omap4_pmic_init("twl6030", &tate_twldata,
...
static struct omap_board_mux board_mux[] __initdata = {
	...
	/* TOUCH IRQ - GPIO 24 */
	OMAP4_MUX(DPM_EMU13, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
...
static void tate_platform_init(void)
{
	/*
...
#if (CONFIG_TOUCHSCREEN_ATMEL_MXT)  || defined(CONFIG_TOUCHSCREEN_ATMEL_MXT_MODULE)
static void __init omap4_touch_init(void)
{
        int error;
...
static void __init omap_tate_init(void)
{
...
static void __init omap_tate_reserve(void)
{
	omap_init_ram_size();
...
MACHINE_START(OMAP4_BOWSER, "OMAP4 TATE board")
	.atag_offset	= 0x100,
	.reserve	= omap_tate_reserve,
	.map_io		= omap4_map_io,
	.init_early	= omap4430_init_early,
	.init_irq	= gic_init_irq,
	.handle_irq	= gic_handle_irq,
	.init_machine	= omap_tate_init,
	.timer		= &omap4_timer,
